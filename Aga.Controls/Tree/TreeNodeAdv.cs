...
namespace Aga.Controls.Tree
{
	...
	public sealed class TreeNodeAdv : ISerializable
	{
		...
		private class NodeCollection : SynchronizedCollection<TreeNodeAdv>
		{
		...
		private SynchronizedCollection<TreeNodeAdv> _nodes;
		internal SynchronizedCollection<TreeNodeAdv> Nodes
		{
			get { return _nodes; }
		}
